...
const IconButton = ({
  ...
  return (
    <button
      className={clsx(
        "ui-relative ui-btn-ghost ui-rounded-full ui-w-fit ui-p-2 ui-transition-colors",
        className
      )}
    ...
    >
      ...
      {isHovered && tooltip ? (
        <span className="ui-absolute ui-left-1/2 ui-right-1/2 -ui-translate-x-1/2 ui-bottom-[calc(100%+0.5rem)] ui-w-fit">
          <span
            className={clsx(
              "ui-bg-base-content ui-rounded-lg ui-truncate ui-py-2 ui-px-3 ui-w-fit ui-shadow-sm ui-h-fit",
          ...
          <span className="ui-absolute ui-z-50 ui-h-2 ui-w-2 ui-flex ui-right-1/2 -ui-bottom-1 ui-left-1/2 -ui-translate-x-1/2">
            <span className="ui-bg-base-content ui-h-full ui-w-full ui-flex ui-rotate-45" />
          </span>
        </span>
      ) : null}
    </button>
